  ...
  render() {
    return (
      <div className={ 'card color-' + this.props.infos.color}>
          ...
          <footer>
            <div className="left">    { this.props.infos.bottom.left } </div>
            <div className="center">  { this.props.infos.bottom.center } </div>
            <div className="right">   { this.props.infos.bottom.right } </div>
          </footer>
      </div>
    )
  }
